                ...
                <div class="right-side">
                    <div class="card">
                        ...
                        <div class="leaf-container mb-5">
                           <label>NAME:</label><br/>
                           <input type="text" placeholder="enter your name" className="form-control"  style={{border:"1px solid black"}}/>
                        </div>
                        
                        <Link to="/banner_sectionsurname"><button class="leafbutton">Next Question <i class="fa-solid fa-arrow-right"></i></button></Link>
                    </div>
                </div>
            </div>
