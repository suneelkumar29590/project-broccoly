                ...
                <div class="right-side">
                    <div class="card">
                        ...
                        <div class="leaf-container mb-5">
                           ...
                           <input type="text" placeholder="enter your email" className="form-control w-75"  style={{border:"1px solid black"}}/>
                        </div>
                       
                        <Link to="/banner_sectionphone"><button class="leafbutton">Next Question <i class="fa-solid fa-arrow-right"></i></button></Link>
                    </div>
                </div>
            </div>
