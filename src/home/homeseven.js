                ...
                <div class="right-side">
                    <div class="card">
                        ...
                        <div class="leaf-container mb-5">
                           ...
                           <input type="text" placeholder="enter your phonenumber" className="form-control w-50"  style={{border:"1px solid black"}}/>
                        </div>
                        
                        <Link to="/banner_sectionthankyou"><button class="leafbutton">Next Question <i class="fa-solid fa-arrow-right"></i></button></Link>
                    </div>
                </div>
            </div>
