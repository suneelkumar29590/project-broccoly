                ...
                <div class="right-side">
                    <div class="card">
                        ...
                        <label>WEIGHT:</label><br/>
                           <input type="text" placeholder="enter your weight" className="form-control"  style={{border:"1px solid black"}}/>
                        </div>
                        
                        <Link to="/banner_sectionname"><button class="leafbutton">Next Question <i class="fa-solid fa-arrow-right"></i></button></Link>
                    </div>
                </div>
            </div>
