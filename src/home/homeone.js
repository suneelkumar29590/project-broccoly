           ...
           <Header2/>
            ...
            <div class="banner">
                ...
                <div class="right-side">
                    <div class="card">
                        <h2>I Am a</h2>
                        <div class="leaf-container mb-5 row">
                            <div class="leaf col-sm-4 col-md-4">
                                <div class="name">Man<br /><input type="radio" name="type" className="radio-button"/></div>
                            </div>
                            <div class="leaf col-sm-4 col-md-4">
                                <div class="name">Woman<br /><input type="radio" name="type" className="radio-button"/></div>
                            </div>
                        </div>
                        
                        <Link to="/banner_sectionage"><button class="leafbutton">Next Question<i class="fa-solid fa-arrow-right"></i></button></Link>
                    </div>
                </div>
            </div>
