...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div class="banner">
                <div class="left-side">
                    <button className="bannerbtnget w-50 p-2">Get Started Now <i class="fa-solid fa-arrow-right"></i></button>
                ...
                <div class="right-side ">
                    <div class="card">
                        <h2>I want to lose</h2>
                        <div class="leaf-container row">
                            <div class="leaf col-sm-4 col-md-4">
                                <div class="name">Under a stone<br /><input type="radio" name="type" className="radio-button" /></div>
                            </div>
                            <div class="leaf col-sm-4 col-md-4">
                                <div class="name">Over a stone<br /><input type="radio" name="type" className="radio-button" /></div>
                            </div>
                        </div>
                        <p className="mt-5">Getting your quote is quick and free!</p>
                        <Link to="/banner_sectionman"><button class="leafbutton">Start my quote <i class="fa-solid fa-arrow-right"></i></button></Link>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="slide slide_1">
                                            <div class="slide-content row">
                                                <div className="col-12 col-md-4">
                                                    ...
                                                    <h6 className="slideh6">I had been on broccolly a few years ag...</h6>
                                                ...
                                                <div className="col-12 col-md-4">
                                                    <p className="">Reviews<i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i></p>
                                                    <h6  className="slideh6">The best meals</h6>
                                                    <p>The best meals Missy Moham, 31 July</p>

                                                </div>
                                                <div className="col-12 col-md-4">
                                                    <p className="">Reviews<i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i><i class="fa-regular fa-star greenstar"></i></p>
                                                    <h6  className="slideh6">Excellent Customer Service</h6>
