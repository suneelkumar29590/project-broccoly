  ...
  return (
    <div style={{ overflowX: isOverflowHidden ? 'hidden' : 'auto' }}>
      ...
      <div className="row">
                ...
                <div className="col-12 col-sm-6  col-md-2 text-center">
                <Link to="/meallunch"><button className="dietmealbreakbtn1">Lunch</button></Link>
                </div>
                <div className="col-12 col-sm-6  col-md-2 text-center">
                <Link to="/mealdinner"><button className="dietmealbreakbtn">Dinner</button></Link>
                </div>
                <div className="col-12 col-sm-6  col-md-2 text-center">
      ...
      <div className="container42">
        <div className="row">
          <div className="col-12 col-md-6">
            <h2 className="dietbreakh2">Dinner</h2>
            <p className="mt-3">Dine on your favourite dishes with Diet Chef! Choose from our range of nutritional diet meals from Indian to Italian and British classics. We’ve plenty of vegetarian options too.

              Just add fresh vegetables, fruit or a simple side salad to complete your low-calorie meals.**</p>
          </div>
