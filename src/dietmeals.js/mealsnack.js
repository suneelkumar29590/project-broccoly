  ...
  return (
    <div style={{ overflowX: isOverflowHidden ? 'hidden' : 'auto' }}>
      ...
      <div className="row">
                ...
                <div className="col-12 col-sm-6  col-md-2 text-center">
                <Link to="/mealsnack"><button className="dietmealbreakbtn">Snacks</button></Link>
                </div>
      ...
      <div className="container42">
        <div className="row">
          <div className="col-12 col-md-6">
            <h2 className="dietbreakh2">Snacks</h2>
            <p className="mt-3">Think you can’t snack on a diet? Think again! Our range of snacks are perfect with a cup of tea or as an evening snack.</p>
          </div>
