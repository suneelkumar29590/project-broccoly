      ...
      <Header2/>
            <div class="banner">
                <div class="left-side">
                    ...
                    <a href="#mealspage"><button className="w-50 dietbreakbutton">view Meals <i class="fa-solid fa-arrow-down"></i></button></a>
                </div>
            ...
            <div className="container41 mt-5">
              <div className="row">
                ...
                <div className="col-12 col-sm-6 col-md-2 text-center">
                  <Link to="/mealbreakfast"><button className="dietmealbreakbtn shadow">Breakfast</button></Link>
                </div>
                <div className="col-12 col-sm-6  col-md-2 text-center">
                <Link to="/meallunch"><button className="dietmealbreakbtn1 shadow">Lunch</button></Link>
                </div>
                <div className="col-12 col-sm-6  col-md-2 text-center">
                <Link to="/mealdinner"><button className="dietmealbreakbtn1 shadow">Dinner</button></Link>
                </div>
                <div className="col-12 col-sm-6  col-md-2 text-center">
                <Link to="/mealsnack"><button className="dietmealbreakbtn1 shadow">Snacks</button></Link>
                </div>
            ...
            <div className="container42">
              <div className="row">
                <div className="col-12 col-md-6">
                  <h2 className="dietbreakh2">Breakfast</h2>
                  <p className="mt-3">Breakfast is the most important meal of the day so start the day off right with one of our filling, low-calorie breakfasts! Our range of muesli, granola and porridge are all perfect with some fresh fruit and yogurt or grab a soft cookie or bar as a tasty on-the go option to start your day.</p>
                </div>
