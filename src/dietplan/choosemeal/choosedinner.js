...
const Dinner = () => {
    ...
    const [type_of_food,settype_of_food]=useState("dinner");
            ...
            <div className="container15" id="backtotop">
                <div className="row">
                    ...
                    <div className="row">
                        ...
                        <Link to="/dinner" className="col-12 col-sm-6 col-md-2"><button className="breakbtn mx-1 bg-white"  onClick={() => handleButtonClick('dinner')}>Dinner 28/28</button></Link>
