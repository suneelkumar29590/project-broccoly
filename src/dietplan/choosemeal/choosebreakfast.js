...
const Breakfast = () => {
    ...
    const [type_of_food,settype_of_food]=useState("breakfast");
            ...
            <div className="container15" id="backtotop">
                <div className="row">
                    ...
                    <div className="row">
                        ...
                        <Link to="/breakfast" className="col-12 col-sm-6 col-md-2 " ><button className="breakbtn mx-1 bg-white"  onClick={() => handleButtonClick('breakfast')}>Breakfast 28/28</button></Link>
                        <Link to="/lunch" className="col-12 col-sm-6 col-md-2 " ><button className="breakbtn mx-1"  onClick={() => handleButtonClick('lunch')}>Lunch 28/28</button></Link>
