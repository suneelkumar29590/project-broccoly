...
const Snack = () => {
    ...
    const [type_of_food,settype_of_food]=useState("snacks");
            ...
            <div className="container15" id="backtotop">
                <div className="row">
                    ...
                    <div className="row">
                        ...
                        <Link to="/snack" className="col-12 col-sm-6 col-md-2 "><button className="breakbtn mx-1 bg-white"  onClick={() => handleButtonClick('snacks')}>Snacks 28/28</button></Link>
                    </div>
                </div>
            </div>
            <ToastContainer
