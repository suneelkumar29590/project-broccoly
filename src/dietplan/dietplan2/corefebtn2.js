...
const Corefemale2 = () => {
    ...
    const [type_of_person, settype_of_person]=useState("female")
    const [type_of_plan, settype_of_plan]=useState("Lose1-2stone")
    const[amount,setamount]=useState("20")
    const [data, setdata] = useState([]);

    let navigate = useNavigate();

    const handleButtonClick = (type_of_person) => {
        settype_of_person(type_of_person);
      };
      const handleButtonClick1 = (type_of_plan) => {
        settype_of_plan(type_of_plan);
      };
    ...
    const onSubmitForm=(e)=>{
        ...
        if(
            type_of_person && type_of_plan && amount !==""
        ){
            axios.post("http://localhost:3001/dietplan/",usersData)
            .then((response)=>{
            ...
            <div className='container13'>
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <Link to="/core"><button className='vegfemalebtn'  onClick={() => handleButtonClick('male')}>Male</button></Link>
                        <button className='vegmalebtn'  onClick={() => handleButtonClick('female')}>Female</button>
                        <h4 className='mb-5 mt-5 dietplan2h1'>Choose a meal plan</h4>
                        <div className='row'>
                        <Link className='col-md-4' to="/corefemale"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose2-3stone')}>
                                <p>Lose2-3 stone</p>
                                <p>24 week<br />$349.00<br />/ 4 weeks</p>
                                <p>Save $90 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-sm-4 col-md-4' to="/corefebtn2"><button className='vegbutton'  onClick={() => handleButtonClick1('Lose1-2stone')}>
                                <p>Lose1-2 stone</p>
                                <p>24 week<br />$369.00<br />/ 4 weeks</p>
                                <p>Save $70 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4' to="/corefebtn3"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose11-13stone')}>
                                <p>Lose11-13 stone</p>
                                <p>24 week<br />$389.00<br />/ 4 weeks</p>
                                <p>Save $50 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4 mt-5' to="/corefebtn4"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose6-9stone')}>
                                <p>Lose6-9 stone</p>
                                <p>24 week<br />$419.00<br />/ 4 weeks</p>
                                <p>Save $20 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4 mt-5' to="/corefebtn5"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose2-4stone')}>
                                <p>Lose2-4 stone</p>
                ...
                <ToastContainer />
                        ...
                        <form className='row' onSubmit={onSubmitForm}>
                            ...
                            <p className='col-md-6'></p>
                            <h6 className='col-md-3'  onClick={() => handleButtonClick2('$20.00')}>$20.00</h6>
                            <hr />
                            <h6 className='col-md-3'>Following hampers</h6>
                            <p className='col-md-6'></p>
                            <h6 className='col-md-3'>$20.00<br />(every 4 weeks)</h6>
                            <button className='vegchoose w-100'>Choose meals</button>
