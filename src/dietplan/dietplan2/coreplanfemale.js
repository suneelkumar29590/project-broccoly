...
const Corefemale = () => {
    ...
    const [type_of_plan, settype_of_plan]=useState("Lose2-3stone")
            ...
            <div className='container13'>
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <div className='row'>
                        <Link className='col-sm-4 col-md-4' to="/corefemale"><button className='vegbutton' onClick={() => handleButtonClick1('Lose2-3stone')}>
                                <p>Lose2-3 stone</p>
                                <p>24 week<br />$349.00<br />/ 4 weeks</p>
                                <p>Save $90 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4' to="/corefebtn2"><button className='vegbutton1' onClick={() => handleButtonClick1('Lose1-2stone')}>
                                <p>Lose1-2 stone</p>
