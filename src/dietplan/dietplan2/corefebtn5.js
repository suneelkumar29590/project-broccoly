                ...
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <Link className='col-sm-4 col-md-4' to="/corefemale"><button className='vegbutton1'>
                            ...
                            <Link className='col-sm-4 col-md-4' to="/corefebtn3"><button className='vegbutton1'>
                                <p>Lose11-13 stone</p>
                            ...
                            <Link className='col-sm-4 col-md-4 mt-5' to="/corefebtn5"><button className='vegbutton'>
                                <p>Lose2-4 stone</p>
