            ...
            <div className='container13'>
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <Link to="/core"><button className='vegfemalebtn'>Male</button></Link>
                        <button className='vegmalebtn'>Female</button>
                        <h4 className='mb-5 mt-5 dietplan2h1'>Choose a meal plan</h4>
                        <div className='row'>
                        <Link className='col-sm-4 col-md-4' to="/corefemale"><button className='vegbutton1'>
                                <p>Lose2-3 stone</p>
                                <p>24 week<br />$349.00<br />/ 4 weeks</p>
                                <p>Save $90 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4' to="/corefebtn2"><button className='vegbutton1'>
                                <p>Lose1-2 stone</p>
                                <p>24 week<br />$369.00<br />/ 4 weeks</p>
                                <p>Save $70 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4' to="/corefebtn3"><button className='vegbutton'>
                                <p>Lose11-13 stone</p>
                                <p>24 week<br />$389.00<br />/ 4 weeks</p>
                                <p>Save $50 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4 mt-5' to="/corefebtn4"><button className='vegbutton1'>
                                <p>Lose6-9 stone</p>
                                <p>24 week<br />$419.00<br />/ 4 weeks</p>
                                <p>Save $20 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4 mt-5' to="/corefebtn5"><button className='vegbutton1'>
                                <p>Lose2-4 stone</p>
