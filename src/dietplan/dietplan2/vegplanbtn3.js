                ...
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <div className='row'>
                            ...
                            <Link to="/vegbtn3" className='col-sm-4 col-md-4'><button className='vegbutton'>
                                <p>Lose11-13 stone</p>
                                <p>24 week<br />$389.00<br />/ 4 weeks</p>
                                <p>Save $50 per month</p>
                            </button></Link>
                            <Link to="/vegbtn4" className='col-sm-4 col-md-4 mt-5'><button className='vegbutton1'>
                                <p>Lose6-9 stone</p>
