            ...
            <div className='container13'>
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <div className='row'>
                            <Link to="/veg" className='col-sm-4 col-md-4'><button className='vegbutton1'>
                                <p>Lose2-3 stone</p>
                                <p>24 week<br />$349.00<br />/ 4 weeks</p>
                                <p>Save $90 per month</p>
                            </button></Link>
                            <Link to="/vegbtn2" className='col-sm-4 col-md-4'><button className='vegbutton1'>
                                <p>Lose1-2 stone</p>
                                <p>24 week<br />$369.00<br />/ 4 weeks</p>
                                <p>Save $70 per month</p>
                            </button></Link>
                            <Link to="/vegbtn3" className='col-sm-4 col-md-4'><button className='vegbutton1'>
                                <p>Lose11-13 stone</p>
                                <p>24 week<br />$389.00<br />/ 4 weeks</p>
                                <p>Save $50 per month</p>
                            </button></Link>
                            <Link to="/vegbtn4" className='col-sm-4 col-md-4 mt-5'><button className='vegbutton'>
                                <p>Lose6-9 stone</p>
                                <p>24 week<br />$419.00<br />/ 4 weeks</p>
                                <p>Save $20 per month</p>
                            </button></Link>
                            <Link to="/vegbtn5" className='col-sm-4 col-md-4 mt-5'><button className='vegbutton1'>
                                <p>Lose2-4 stone</p>
