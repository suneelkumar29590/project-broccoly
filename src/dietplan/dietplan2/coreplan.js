...
const Core=()=>{
    ...
    const [type_of_person, settype_of_person]=useState("male")
        ...
        <div className='container13'>
            <div className='row'>
                ...
                <div className='col-12 col-md-5 vegright'>
                    ...
                    <button className='vegmalebtn'  onClick={() => handleButtonClick('male')}>Male</button>
                    <Link to="/corefemale"><button className='vegfemalebtn'  onClick={() => handleButtonClick('female')}>Female</button></Link>
                    <h4 className='mb-5 mt-5 dietplan2h1'>Choose a meal plan</h4>
                    <div className='row'>
                    <Link className='col-sm-4 col-md-4' to="/core"><button className='vegbutton'  onClick={() => handleButtonClick1('Lose2-3stone')}>
                            <p>Lose2-3 stone</p>
                            <p>24 week<br />$349.00<br />/ 4 weeks</p>
                            <p>Save $90 per month</p>
                        </button></Link>
                        <Link className='col-sm-4 col-md-4' to="/corebtn2"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose1-2stone')}>
                            <p>Lose1-2 stone</p>
                            <p>24 week<br />$369.00<br />/ 4 weeks</p>
                            <p>Save $70 per month</p>
                        </button></Link>
                        <Link className='col-sm-4 col-md-4' to="/corebtn3"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose11-13stone')}>
                            <p>Lose11-13 stone</p>
                            <p>24 week<br />$389.00<br />/ 4 weeks</p>
                            <p>Save $50 per month</p>
                        </button></Link>
                        <Link className='col-sm-4 col-md-4 mt-5' to="/corebtn4"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose6-9stone')}>
                            <p>Lose6-9 stone</p>
                            <p>24 week<br />$419.00<br />/ 4 weeks</p>
                            <p>Save $20 per month</p>
                        </button></Link>
                        <Link className='col-sm-4 col-md-4 mt-5' to="/corebtn5"><button className='vegbutton1'  onClick={() => handleButtonClick1('Lose2-4stone')}>
                            <p>Lose2-4 stone</p>
