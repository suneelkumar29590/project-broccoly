                ...
                <div className='row'>
                    ...
                    <div className='col-12 col-md-5 vegright'>
                        ...
                        <Link className='col-sm-4 col-md-4' to="/vegfemale"><button className='vegbutton1'>
                            ...
                            <Link className='col-sm-4 col-md-4 mt-5' to="/vegfebtn4"><button className=' vegbutton1'>
                                <p>Lose6-9 stone</p>
                                <p>24 week<br />$419.00<br />/ 4 weeks</p>
                                <p>Save $20 per month</p>
                            </button></Link>
                            <Link className='col-sm-4 col-md-4 mt-5' to="/vegfebtn5"><button className='vegbutton'>
                                <p>Lose2-4 stone</p>
...
export default Vegetarianfemale5;